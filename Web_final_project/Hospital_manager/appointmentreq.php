...
header('location: ../login.php');
  ...
  $q = "select * from appointmentconfirm";
...
$(document).ready(function(){
  ...
  <div class="">
    <div class="" style="display:flex;margin-top:20px;">
      <form class="" action="../Hospital_manager/apbookreq.php" method="post">
        <h3 style="color: white; font-family: 'Avro';margin-left:40px;">Serial</h3>
          <input type="number"  placeholder="Enter name" name="serial" style="margin-left: 30px;background-color: transparent;border: none;
  ...
  <h2  style="color: #212b25;">Appoinment Request</h2>
