...
header('location: ../login.php');
  ...
  $q = "select * from message where (receiver = '$a' OR receiver = 'admin')
   AND (sender = '$a' OR sender = 'admin') order by serial";
...
<html lang="en" dir="ltr">
  ...
  <h3 style="color: white; font-family: 'Avro';margin-left:0px;">Message</h3>
            <form action="../Medical_store/validmessage.php" method="POST">
              <input type="text"  placeholder="Enter name" name="message" style="margin-left: 0px;background-color: transparent;border: none;
